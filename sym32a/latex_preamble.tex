...
%	/tikz/circuitikz/bipoles/tline/width=1.2,%0.8
  ...
  transistors/scale=1.618
}
\ctikzset{v/.append style={/tikz/european voltages}}

\definecolor{netlabelcolor}{HTML}{339af0}
\definecolor{componentLabelColor}{HTML}{495057}
\definecolor{lttotitextcolor}{HTML}{a5d8ff}
\definecolor{lttotidrawcolor}{HTML}{a5d8ff}
\definecolor{netcolor}{HTML}{343a40}
...
\begin{document}%
	%\centering%
		\begin{tikzpicture}[circuit ee IEC, scale=0.6666666667,line width=.5pt, color=netcolor, /tikz/text=componentLabelColor]% default: 0.4
